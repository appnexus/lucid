...
export function buildHybridComponent(baseComponent, {
	...
	return React.createClass({
		...
		displayName,
		getInitialState() {
			const { initial } = this.props; //initial state overrides
			return _.mergeWith({}, omitFunctionPropsDeep(baseComponent.getDefaultProps()), initial, omitFunctionPropsDeep(this.props), safeMerge);
		},
		componentWillMount() {
