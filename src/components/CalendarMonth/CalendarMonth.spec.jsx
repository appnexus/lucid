...
describe('CalendarMonth', () => {
	...
	describe('modifierRange', () => {
		...
		it('dates between `from` and `cursor` should be in range', () => {
			...
			const calendarMonthInstance = wrapper.instance();
			const isInRange11 = calendarMonthInstance.modifierRange(new Date('2017-02-11T00:00:00Z'));
			const isInRange12 = calendarMonthInstance.modifierRange(new Date('2017-02-12T00:00:00Z'));
			const isInRange13 = calendarMonthInstance.modifierRange(new Date('2017-02-13T00:00:00Z'));
			const isInRange14 = calendarMonthInstance.modifierRange(new Date('2017-02-14T00:00:00Z'));
			const isInRange15 = calendarMonthInstance.modifierRange(new Date('2017-02-15T00:00:00Z'));
	...
	describe('modifierFrom', () => {
		it('should mark `from` day', () => {
			...
			const calendarMonthInstance = wrapper.instance();
			const isFromDate = calendarMonthInstance.modifierFrom(new Date('2017-02-14T00:00:00Z'));
	...
	describe('modifierTo', () => {
		it('should mark `to` day', () => {
			...
			const calendarMonthInstance = wrapper.instance();
			const isToDate = calendarMonthInstance.modifierTo(new Date('2017-02-14T00:00:00Z'));
