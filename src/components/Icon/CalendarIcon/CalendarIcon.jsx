	...
	render() {
		...
		return (
			...
			>
				<path
					opacity="0.25"
					d="M15,7V6h-2V4h-1v2h-2V4H9v2H7V4H6v2H4V4H3v2H1v1h2v2H1v1h2v2H1v1h2v2h1v-2h2v2 h1v-2h2v2h1v-2h2v2h1v-2h2v-1h-2v-2h2V9h-2V7H15z M9,7v2H7V7H9z M4,7h2v2H4V7z M4,12v-2h2v2H4z M7,12v-2h2v2H7z M12,12h-2v-2h2V12z M12,9h-2V7h2V9z"
				/>
