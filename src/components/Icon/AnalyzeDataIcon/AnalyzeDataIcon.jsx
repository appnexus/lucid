	...
	render() {
		...
		return (
			...
			>
				...
				<path
					opacity="0.1"
					d="M12.476,5.12L10,7.709V14h3V5.348C12.812,5.297,12.636,5.222,12.476,5.12z"
				/>
				<path
					opacity="0.25"
					d="M11.801,4.378L9.477,6.81L5.805,4.135L5.5,4.552L5.196,4.134L1.263,7H1v7h1 V7.7l3-2.185V14h1V5.515L9,7.7V14h1V7.709l2.476-2.589C12.189,4.938,11.958,4.682,11.801,4.378z"
				/>
				<path
					opacity="0.25"
					d="M13.5,5.422c-0.174,0-0.34-0.031-0.5-0.074V14h1V5.348 C13.84,5.391,13.674,5.422,13.5,5.422z"
				/>
