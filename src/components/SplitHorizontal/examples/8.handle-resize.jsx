		...
		return(
			...
			New Height: {`${this.state.newHeight}`}
				...
				<section style={{ height: 300, outline: '1px solid #e3e3e3' }}>
					...
					<SplitHorizontal style={{ height: '100%' }} onResizing={this.handleResizing} onResize={this.handleResize}>
