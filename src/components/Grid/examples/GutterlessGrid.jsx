	...
	render() {
		return (
			<Grid isGutterless isMultiline>
				...
				<Grid.Cell style={{...gridStyle.quarter, ...gridStyle.sharedStyles}} isQuarter>gutterless quarter</Grid.Cell>
				{fillCells(1)}
				<Grid.Cell isQuarter>
					<p style={{...gridStyle.quarter, ...gridStyle.sharedStyles}}>gutterless quarter</p>
				</Grid.Cell>
				<Grid.Cell isQuarter>
					<p style={{...gridStyle.quarter, ...gridStyle.sharedStyles}}>gutterless quarter</p>
				</Grid.Cell>
