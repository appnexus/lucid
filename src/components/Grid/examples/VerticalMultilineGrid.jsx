	...
	render() {
		return (
			<Grid style={{...gridStyle.vertical}} isVertical isMultiline>
				<Grid.Cell isHalf>
					<p  style={{...gridStyle.half, ...gridStyle.verticalSharedStyles}}>half</p>
				</Grid.Cell>
				<Grid.Cell isHalf>
					<p  style={{...gridStyle.half, ...gridStyle.verticalSharedStyles}}>half</p>
				</Grid.Cell>
				...
				<Grid.Cell isFull>
					<p  style={{...gridStyle.full, ...gridStyle.verticalSharedStyles}}>full</p>
				</Grid.Cell>
				<Grid.Cell isThird>
					<p  style={{...gridStyle.third, ...gridStyle.verticalSharedStyles}}>third</p>
				</Grid.Cell>
				<Grid.Cell isThird>
					<p  style={{...gridStyle.third, ...gridStyle.verticalSharedStyles}}>third</p>
				</Grid.Cell>
