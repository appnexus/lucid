	...
	describe('props', () => {
		...
		describe('onToggle', () => {
			it('should be called when the expander button is clicked', () => {
				...
				const expanderWrapper = wrapper.find('.lucid-Sidebar > .lucid-Sidebar-Bar > .lucid-Sidebar-Bar-header > .lucid-Sidebar-expander');
