				...
				notes: {
					...
					intendedUse: `
						...
						**Styling notes**
						...
						- Use \`isSelectedHighlighted='false'\` if the default selection is All or a null state. See the \`no selection highlighting\` example. The grey outline indicates that this selection does not need users' attention.
						- Use \`isInvisible\` for filters within a full page table header. See the \`invisible\` example. The lack of outline allows the dropdown to have a lighter visual weight within a data-intense layout.
					`,
