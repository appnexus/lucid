	...
	describe('props', () => {
		...
		describe('className', () => {
			...
			describe('FlyOut', () => {
				...
				it('should pass the className prop thru to the FlyOut (portal) element', () => {
					...
					const flyOutClassName = document.querySelector('.lucid-DropMenu.lucid-ContextMenu-FlyOut').className;
		...
		describe('isExpanded', () => {
			it('should pass isExpanded to the underlying ContextMenu component thru props', () => {
				...
				const contextMenuIsExpanded = wrapper.find('ContextMenu').prop('isExpanded');
		...
		describe('direction', () => {
			it('should pass the direction to the underlying ContextMenu component thru props', () => {
				...
				const contextMenuDirection = wrapper.find('ContextMenu').prop('direction');
		...
		describe('selectedIndices', () => {
			...
			it('should render the selected options with appropriate className', () => {
				...
				assert(_.includes(optionDOMNodes[0].className, 'lucid-DropMenu-Option-is-selected'));
				assert(!_.includes(optionDOMNodes[1].className, 'lucid-DropMenu-Option-is-selected'));
				assert(_.includes(optionDOMNodes[2].className, 'lucid-DropMenu-Option-is-selected'));
			});
		});
		...
		describe('focusedIndex', () => {
			...
			it('should render the focused option with appropriate className', () => {
				...
				assert(!_.includes(optionDOMNodes[0].className, 'lucid-DropMenu-Option-is-focused'));
				assert(!_.includes(optionDOMNodes[1].className, 'lucid-DropMenu-Option-is-focused'));
				assert(_.includes(optionDOMNodes[2].className, 'lucid-DropMenu-Option-is-focused'));
			});
		});
	...
	describe('child elements', () => {
		...
		describe('OptionGroup', () => {
			...
			it('should render the Options in each OptionGroup separated by dividers', () => {
				...
				assert(_.includes(flyOutDOMNode.children[0].className, 'lucid-DropMenu-Option-is-grouped'));
				assert(_.includes(flyOutDOMNode.children[1].className, 'lucid-DropMenu-Option-is-grouped'));
				assert(_.includes(flyOutDOMNode.children[2].className, 'lucid-DropMenu-Option-is-grouped'));
				assert(_.includes(flyOutDOMNode.children[4].className, 'lucid-DropMenu-Option-is-grouped'));
				assert(_.includes(flyOutDOMNode.children[5].className, 'lucid-DropMenu-Option-is-grouped'));
				assert(_.includes(flyOutDOMNode.children[7].className, 'lucid-DropMenu-Option-is-grouped'));
				assert(_.includes(flyOutDOMNode.children[8].className, 'lucid-DropMenu-Option-is-grouped'));
				assert(_.includes(flyOutDOMNode.children[9].className, 'lucid-DropMenu-Option-is-grouped'));
			});
			...
			it('should render the ungrouped and grouped Options separated by dividers', () => {
				...
				assert(!_.includes(flyOutDOMNode.children[4].className, 'lucid-DropMenu-Option-is-grouped'));
				assert(!_.includes(flyOutDOMNode.children[5].className, 'lucid-DropMenu-Option-is-grouped'));
				assert(!_.includes(flyOutDOMNode.children[6].className, 'lucid-DropMenu-Option-is-grouped'));
			});
		...
		describe('NullOption', () => {
			...
			it('should render NullOption first with a divider immediately following', () => {
				...
				assert(_.includes(flyOutDOMNode.children[0].className, 'lucid-DropMenu-Option'));
				assert(_.includes(flyOutDOMNode.children[0].className, 'lucid-DropMenu-Option-is-null'));
