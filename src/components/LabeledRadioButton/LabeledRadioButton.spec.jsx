...
describe('LabeledRadioButton', () => {
	common(LabeledRadioButton);

	describe('props', () => {
		describe('isDisabled', () => {
			it('passes the value through to its `RadioButton` instance.', () => {
				const wrapper = shallow(<LabeledRadioButton isDisabled={true} />);

				assert.equal(wrapper.find(RadioButton).prop('isDisabled'), true);
			});

			it('defaults to `false`.', () => {
				const wrapper = mount(<LabeledRadioButton />);
		...
		describe('isSelected', () => {
			it('passes the value through to its `RadioButton` instance.', () => {
				const wrapper = shallow(<LabeledRadioButton isSelected={true} />);
		...
		describe('onSelect', () => {
			it('passes the value through to its `RadioButton` instance.', () => {
				const foo = () => null;
				const wrapper = shallow(<LabeledRadioButton onSelect={foo} />);
