			...
			<div className={cx('&', {
				...
				<svg viewBox='0 0 400.4 179.8' width={400}>
					<g>
						...
						<path id='XMLID_15_' d='M243.7,122l-7.2,20.6h3.7l1.3-4h8.1l1.3,4h3.9l-7.2-20.6H243.7z M242.8,135.1l2.9-8.6l2.9,8.6
							H242.8z'/>
						<path id='XMLID_12_' d='M267.7,128.4c-0.9-0.7-2.1-1.3-3.6-1.3c-1.6,0-3.3,0.6-4.2,2l-0.2-1.6h-3v20.2h3.6v-6.4
						...
						<path id='XMLID_9_' d='M283.3,128.4c-0.9-0.7-2.1-1.3-3.6-1.3c-1.6,0-3.3,0.6-4.2,2l-0.2-1.6h-3v20.2h3.6v-6.4
						...
						<polygon id='XMLID_8_' points='300.7,135.9 292.1,122 288,122 288,142.6 292,142.6 292,128.4 300.6,142.6 304.7,142.6
							304.7,122 300.7,122 	'/>
						<path id='XMLID_5_' d='M315.5,139.2c-0.5,0.5-1.1,0.7-2.2,0.7c-1,0-1.7-0.3-2.2-0.8c-0.7-0.7-1.1-2-1.1-2.8h10
						...
						<polygon id='XMLID_4_' points='330.6,127.6 327.4,132.4 324.1,127.6 319.9,127.6 325.2,134.9 319.9,142.6 323.9,142.6
							327.2,137.6 330.5,142.6 334.5,142.6 329.4,135 334.6,127.6 	'/>
						<path id='XMLID_3_' d='M345.1,135.4c0,1.2-0.2,2.6-1.1,3.4c-0.4,0.4-1,0.7-1.8,0.7c-1.9,0-2.6-1.1-2.6-2.8v-9.1H336
							v9.9c0,3.2,2,5.3,5.2,5.3c1.9,0,3.6-0.8,4.3-2.2l0.3,2h3v-15.1h-3.6V135.4z'/>
						<path id='XMLID_2_' d='M359.2,133.6c-1.5-0.2-1.8-0.3-3.2-0.4c-0.8-0.1-1.7-0.4-1.7-1.5c0-0.8,0.5-1.3,1.1-1.6
